--[[
    🌙 SleepyUI Library (Premium Winhub Edition)
    An ultra-modern, elegant, and smooth UI Framework for Roblox
    Version 5.0.0 (Winhub Exact Clone)
]]
...
local Theme = {
    ...
    Sidebar = Color3.fromRGB(12, 10, 15),
    TopBar = Color3.fromRGB(10, 8, 12),
    Accent = Color3.fromRGB(130, 90, 240),
    Text = Color3.fromRGB(240, 240, 240),
    TextDim = Color3.fromRGB(150, 150, 150),
    Element = Color3.fromRGB(17, 17, 24), -- #111118
    Border = Color3.fromRGB(35, 33, 45)
}

function SleepyUI:CreateWindow(config)
    local title = config.Title or config.Name or "discord.gg/XXX"
    
    local ScreenGui = Instance.new("ScreenGui")
    ScreenGui.Name = "SleepyUIV5"
    ...
    MinIcon.Position = UDim2.new(0.5, -25, 0, 20)
    ...
    local MinW = Instance.new("TextLabel")
    MinW.Size = UDim2.new(1, 0, 1, 0)
    MinW.BackgroundTransparency = 1
    MinW.Text = "W"
    MinW.TextColor3 = Color3.fromRGB(255, 255, 255)
    MinW.TextSize = 28
    MinW.Font = Enum.Font.GothamBold
    MinW.Parent = MinIcon
    ...
    MainFrame.Size = UDim2.new(0, 528, 0, 334)
    MainFrame.Position = UDim2.new(0.5, -264, 0.5, -167)
    ...
    TitlePill.Size = UDim2.new(0, 140, 0, 24)
    TitlePill.Position = UDim2.new(0, 40, 0.5, -12)
    ...
    CloseBtn.Size = UDim2.new(0, 30, 1, -1)
    ...
    MinBtn.Size = UDim2.new(0, 30, 1, -1)
    ...
    TopContentBar.Size = UDim2.new(1, 0, 0, 40)
    ...
    function WindowAPI:Tab(tabConfig)
        ...
        function TabAPI:Section(secConfig)
            ...
            AccFrame.Size = UDim2.new(1, 0, 0, 36)
            ...
            AccBtn.Size = UDim2.new(1, 0, 0, 36)
            ...
            AccTitle.Position = UDim2.new(0, 5, 0, 0)
            ...
            AccDivider.Size = UDim2.new(1, -10, 0, 1)
            AccDivider.Position = UDim2.new(0, 5, 1, -1)
            AccDivider.BackgroundColor3 = Theme.Accent
            ...
            local function updateSize()
                if isOpen then
                    AccFrame.Size = UDim2.new(1, 0, 0, 36 + CLayout.AbsoluteContentSize.Y + 10)
                else
                    AccFrame.Size = UDim2.new(1, 0, 0, 36)
                end
            ...
            AccBtn.MouseButton1Click:Connect(function()
                ...
                TweenService:Create(AccFrame, TweenInfo.new(0.3, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {
                    Size = isOpen and UDim2.new(1, 0, 0, 36 + CLayout.AbsoluteContentSize.Y + 10) or UDim2.new(1, 0, 0, 36)
                }):Play()
            end)
        ...
        local function CreateElementFrame(config)
            ...
            EFrame.Size = UDim2.new(1, 0, 0, config.Desc and 48 or 36)
            ...
            Label.Position = UDim2.new(0, 15, 0, config.Desc and 6 or 9)
            ...
            if config.Desc then
                ...
                Desc.Position = UDim2.new(0, 15, 0, 24)
        ...
        function TabAPI:Toggle(config)
            ...
            TogBtn.Size = UDim2.new(0, 36, 0, 18)
            TogBtn.Position = UDim2.new(1, -50, 0.5, -9)
            ...
            TogCircle.Position = state and UDim2.new(1, -16, 0.5, -7) or UDim2.new(0, 2, 0.5, -7)
            ...
            TogBtn.MouseButton1Click:Connect(function()
                ...
                TweenService:Create(TogCircle, TweenInfo.new(0.2), {Position = state and UDim2.new(1, -16, 0.5, -7) or UDim2.new(0, 2, 0.5, -7)}):Play()
        ...
        function TabAPI:Button(config)
            ...
            Btn.Position = UDim2.new(1, -105, 0.5, -11)
        ...
        function TabAPI:Cycle(config)
            ...
            DropBtn.Position = UDim2.new(1, -155, 0.5, -11)
        ...
        function TabAPI:Dropdown(config)
            ...
            local function RefreshOptions(newValues)
                ...
                for _, val in ipairs(config.Values) do
                    ...
                    OptBtn.MouseEnter:Connect(function() TweenService:Create(OptBtn, TweenInfo.new(0.2), {BackgroundTransparency = 0, BackgroundColor3 = Theme.Background}):Play() end)
                ...
                OptionList.Size = UDim2.new(0, 140, 0, math.min(totalHeight, 132))
            end
            ...
            DropBtn.MouseButton1Click:Connect(function()
                ...
                if isOpen then
                    ...
                    OptionList.Position = UDim2.new(0, absPos.X, 0, absPos.Y + 26)
                else
                    Overlay.Visible = false
                    OptionList.Visible = false
                end
        ...
        function TabAPI:Slider(config)
            ...
            SliderBg.Position = UDim2.new(1, -155, 0.5, -2)
            ...
            ValLabel.Position = UDim2.new(1, -195, 0.5, -10)
